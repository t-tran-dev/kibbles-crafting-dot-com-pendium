...
export default function RecipeModal({recipes, parentId, inventory, inventoryData, craftable, projects, viewState, forceUpdate, index} : {recipes: any, parentId:any, inventory: any, inventoryData: any, craftable: any, projects : any, viewState: any, forceUpdate: any, index: any}) {
    ...
    return (
        <div style={{display: 'flex', justifyContent: 'center'}}>
            <Button onClick={handleOpen} style={recipes.length == 0 ? { display: 'none' } : {}}><ChecklistIcon/></Button>
            <Modal
                open={open}
                onClose={handleClose}
