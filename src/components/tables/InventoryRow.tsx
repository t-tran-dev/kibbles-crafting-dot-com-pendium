    ...
    <React.Fragment>
      <TableRow sx={{ "& > *": { borderBottom: "unset" } }} hover={true}>
        ...
        <TableCell align="right">
          <Button value={row.id} onClick={decreaseItemQuantity}>
            <RemoveIcon pointerEvents="none" />
          </Button>
          {quantity}
          <Button value={row.id} onClick={increaseItemQuantity}>
            <AddIcon pointerEvents="none" />
          </Button>
        </TableCell>

        <TableCell align="right">
          <Button value={row.id} onClick={deleteInventoryItem}>
            Delete &nbsp;
